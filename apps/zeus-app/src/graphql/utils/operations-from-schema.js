        ...
        case 1:
          ...
          operationsDictionary = {
            query: __assign(
              {},
              (_f =
                (_e = schema.getQueryType()) === null || _e === void 0
                  ? void 0
                  : _e.getFields()) !== null && _f !== void 0
                ? _f
                : {}
            ),
            mutation: __assign(
              {},
              (_h =
                (_g = schema.getMutationType()) === null || _g === void 0
                  ? void 0
                  : _g.getFields()) !== null && _h !== void 0
                ? _h
                : {}
            ),
            subscription: __assign(
              {},
              (_k =
                (_j = schema.getSubscriptionType()) === null || _j === void 0
                  ? void 0
                  : _j.getFields()) !== null && _k !== void 0
                ? _k
                : {}
            ),
          };
          documentString = "";
          for (
            _i = 0, _a = Object.entries(operationsDictionary);
            _i < _a.length;
            _i++
          ) {
            (_b = _a[_i]), (operationKind = _b[0]), (operationValue = _b[1]);
            for (
              _c = 0, _d = Object.keys(operationValue);
              _c < _d.length;
              _c++
            ) {
              operationName = _d[_c];
