    ...
    routes: [
      {
        ...
        component: ComponentCreator('/nestjs-typegoose/docs/async-configuration', 'eb5'),
        exact: true,
        sidebar: "someSidebar"
      },
      {
        path: '/nestjs-typegoose/docs/discriminators',
        component: ComponentCreator('/nestjs-typegoose/docs/discriminators', 'df5'),
        exact: true,
        sidebar: "someSidebar"
      },
      {
      ...
      },
      {
        ...
        component: ComponentCreator('/nestjs-typegoose/docs/multiple-connections', 'f80'),
        exact: true,
        sidebar: "someSidebar"
      },
      {
        path: '/nestjs-typegoose/docs/schema-options',
        component: ComponentCreator('/nestjs-typegoose/docs/schema-options', '9c7'),
        exact: true,
        sidebar: "someSidebar"
      },
      {
