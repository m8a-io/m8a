  ...
  [730],
  {
    3905: function (e, n, t) {
      ...
      var s = o.createContext({}),
        l = function (e) {
          let n = o.useContext(s),
            t = n;
          return e && (t = typeof e === "function" ? e(n) : a(a({}, n), e)), t;
        },
        p = function (e) {
          const n = l(e.components);
      ...
      function m(e, n) {
        ...
        if (typeof e === "string" || r) {
          ...
          a[0] = d;
          const c = {};
          for (const s in n) hasOwnProperty.call(n, s) && (c[s] = n[s]);
          (c.originalType = e),
            (c.mdxType = typeof e === "string" ? e : r),
            (a[1] = c);
          for (let l = 2; l < i; l++) a[l] = t[l];
      ...
      var o = t(7462),
        ...
        l = {
          ...
          next: {
            ...
            permalink: "/nestjs-typegoose/docs/async-configuration",
          },
        },
        p = {},
        u = [
          {
            value: "<code>forRoot</code> usage",
            id: "forroot-usage",
            level: 2,
          },
          {
            value: "<code>forRootAsync</code> usage",
      ...
      function m(e) {
        ...
        return (0, i.kt)(
          ...
          (0, i.kt)(
            "p",
            null,
            (0, i.kt)("strong", { parentName: "p" }, "app.module.ts")
          ),
          (0, i.kt)(
            "pre",
            null,
