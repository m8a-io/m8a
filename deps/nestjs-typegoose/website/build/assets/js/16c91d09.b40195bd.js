    ...
    3905: function (e, n, t) {
      ...
      var c = o.createContext({}),
        p = function (e) {
          let n = o.useContext(c),
            t = n;
          return e && (t = typeof e === "function" ? e(n) : s(s({}, n), e)), t;
        },
        u = function (e) {
          const n = p(e.components);
      ...
      function f(e, n) {
        ...
        if (typeof e === "string" || r) {
          ...
          s[0] = y;
          const a = {};
          for (const c in n) hasOwnProperty.call(n, c) && (a[c] = n[c]);
          (a.originalType = e),
            (a.mdxType = typeof e === "string" ? e : r),
            (s[1] = a);
          for (let p = 2; p < i; p++) s[p] = t[p];
      ...
      var o = t(7462),
        ...
        p = {
          ...
          next: {
            ...
            permalink: "/nestjs-typegoose/docs/schema-options",
          },
        },
        u = {},
        l = [
          {
            value: "Note: typegooseOptions with async",
